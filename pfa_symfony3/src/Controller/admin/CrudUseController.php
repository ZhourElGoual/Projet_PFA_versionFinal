...
class CrudUseController extends AbstractController
{
    ...
    public function getAllClients(ClientRepository $clientRepo): Response
    {
    ...
    public function ajouter(Request $request, ClientRepository $clientRepo): Response
    {
        try {
    ...
    public function detail(int $id, ClientRepository $clientRepo): Response
    {
    ...
    public function supprimer(int $id, ClientRepository $clientRepo): Response
    {
        $client = $clientRepo->getClientById($id);
    ...
    public function search(Request $request, ClientRepository $clientRepo): Response
    {
